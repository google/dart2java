...
public class Expect extends dart._runtime.base.DartObject implements barnsleyfern.Expect_interface
{
    public static dart._runtime.types.simple.InterfaceTypeInfo dart2java$typeInfo = new dart._runtime.types.simple.InterfaceTypeInfo(barnsleyfern.Expect.class, barnsleyfern.Expect_interface.class);
    ...
    static {
      barnsleyfern.Expect.dart2java$typeInfo.superclass = dart2java$typeExpr_Object;
    }
