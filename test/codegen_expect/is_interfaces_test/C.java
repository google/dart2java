...
public class C extends dart._runtime.base.DartObject implements is_interfaces_test.C_interface, is_interfaces_test.B_interface
{
    ...
    static {
      is_interfaces_test.C.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
      is_interfaces_test.C.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {new dart._runtime.types.simple.InterfaceTypeExpr(is_interfaces_test.B.dart2java$typeInfo)};
    }
  
    public C(dart._runtime.types.simple.Type type)
    {
