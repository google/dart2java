...
public class Expect extends dart._runtime.base.DartObject implements is_interfaces_test.Expect_interface
{
    ...
    static {
      is_interfaces_test.Expect.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
    }
    public int x;
