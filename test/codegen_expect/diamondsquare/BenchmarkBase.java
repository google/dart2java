...
public class BenchmarkBase extends dart._runtime.base.DartObject implements diamondsquare.BenchmarkBase_interface
{
    ...
    public static diamondsquare.BenchmarkBase_interface _new(dart._runtime.types.simple.Type type, java.lang.String name)
    {
      diamondsquare.BenchmarkBase_interface result;
