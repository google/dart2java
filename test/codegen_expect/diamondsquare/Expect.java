...
public class Expect extends dart._runtime.base.DartObject implements diamondsquare.Expect_interface
{
    public static dart._runtime.types.simple.InterfaceTypeInfo dart2java$typeInfo = new dart._runtime.types.simple.InterfaceTypeInfo(diamondsquare.Expect.class, diamondsquare.Expect_interface.class);
    ...
    static {
      diamondsquare.Expect.dart2java$typeInfo.superclass = dart2java$typeExpr_Object;
    }
