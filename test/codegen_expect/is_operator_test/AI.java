...
public abstract class AI extends dart._runtime.base.DartObject implements is_operator_test.AI_interface, is_operator_test.I_interface
{
    ...
    static {
      is_operator_test.AI.dart2java$typeInfo.superclass = dart2java$typeExpr_Object;
      is_operator_test.AI.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {dart2java$typeExpr_I};
    }
