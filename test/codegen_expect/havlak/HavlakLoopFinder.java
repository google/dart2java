...
public class HavlakLoopFinder extends dart._runtime.base.DartObject implements havlak.HavlakLoopFinder_interface
{
    ...
    public int findLoops()
    {
      ...
      dart.core.List_interface<dart.core.List_interface__int> nonBackPreds = ((dart.core.List_interface) ((dart.core.List_interface<dart.core.List_interface__int>) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<dart.core.List_interface__int>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_List$ltint$0$gt)})), size)));
      dart.core.List_interface<dart.core.List_interface__int> backPreds = ((dart.core.List_interface) ((dart.core.List_interface<dart.core.List_interface__int>) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<dart.core.List_interface__int>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_List$ltint$0$gt)})), size)));
      dart.core.List_interface__int number = ((dart.core.List_interface__int) ((dart.core.List_interface__int) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<java.lang.Integer>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0)})), size)));
      dart.core.List_interface__int header = ((dart.core.List_interface__int) ((dart.core.List_interface__int) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<java.lang.Integer>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0)})), size)));
      dart.core.List_interface__int types = ((dart.core.List_interface__int) ((dart.core.List_interface__int) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<java.lang.Integer>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0)})), size)));
      dart.core.List_interface__int last = ((dart.core.List_interface__int) ((dart.core.List_interface__int) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<java.lang.Integer>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0)})), size)));
      dart.core.List_interface<havlak.UnionFindNode_interface> nodes = ((dart.core.List_interface) ((dart.core.List_interface<havlak.UnionFindNode_interface>) dart.core.List.factory$(((dart._runtime.types.simple.TypeEnvironment<dart.core.List<havlak.UnionFindNode_interface>>) dart2java$localTypeEnv.extend(dart.core.List.factory$$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_UnionFindNode)})), size)));
