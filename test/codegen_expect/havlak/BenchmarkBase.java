...
public class BenchmarkBase extends dart._runtime.base.DartObject implements havlak.BenchmarkBase_interface
{
    ...
    static {
      havlak.BenchmarkBase.dart2java$typeInfo.superclass = dart2java$typeExpr_Object;
    }
    static {
      final dart._runtime.types.simple.TypeEnvironment dart2java$localTypeEnv = dart._runtime.types.simple.TypeEnvironment.ROOT;
      havlak.BenchmarkBase.iters = 10;
    }
    ...
    public static havlak.BenchmarkBase_interface _new_BenchmarkBase$(dart._runtime.types.simple.Type type, java.lang.String name)
    {
