...
public class Expect extends dart._runtime.base.DartObject implements havlak.Expect_interface
{
    ...
    public static void listEquals(dart.core.List_interface<java.lang.Object> expected, dart.core.List_interface<java.lang.Object> actual)
    {
      ...
      {
        havlak.Expect.equals(expected.operatorAt_List(i), actual.operatorAt_List(i));
      }
    }
    ...
    public static havlak.Expect_interface _new_Expect$(dart._runtime.types.simple.Type type)
    {
      havlak.Expect result;
      result = new havlak.Expect(((dart._runtime.helpers.ConstructorHelper.EmptyConstructorMarker) null), type);
      result._constructor();
      return result;
    }
}
