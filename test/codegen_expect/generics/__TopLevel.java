...
public class __TopLevel
{
    ...
    public static void main(String[] args)
    {
      ...
      fooObject.setVariable(12);
      dart.core.__TopLevel.print(foo.getVariable__int());
      foo.setVariable__int(11);
      dart.core.__TopLevel.print(foo.getVariable__int());
      ...
      barObjectDouble.setVarB__generic_double(14.01);
      barIntObject.setVarA__int_generic(13);
      dart.core.__TopLevel.print(barIntObject.bar__int_generic(1, 0.0));
      dart.core.__TopLevel.print(barObjectDouble.getVarB__generic_double());
      ...
      dart.core.__TopLevel.print(factoryBar.getVarB__int_double());
      ...
      nestedGeneric12.setVariable(((generics.Bar2_interface__int_generic) ((generics.Bar2_interface__int_generic<java.lang.Object>) generics.Bar2.<java.lang.Integer, java.lang.Object>factory$newBar(dart2java$localTypeEnv.extend(generics.Bar2.factory$newBar$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0), dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Object)}), 0, 0))));
      nestedGeneric12.setVariable(((generics.Bar2_interface__int_generic) ((generics.Bar2_interface__int_int) generics.Bar2.<java.lang.Integer, java.lang.Integer>factory$newBar(dart2java$localTypeEnv.extend(generics.Bar2.factory$newBar$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0), dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0)}), 50, 51))));
      dart.core.__TopLevel.print(nestedGeneric12.foo(((generics.Bar2_interface__int_generic) nestedGeneric12.getVariable())).getVarA__int_generic());
      dart.core.__TopLevel.print(nestedGeneric12.getVariable().getVarB__int_generic());
      nestedGeneric12.writeVariable(((generics.Bar2_interface__int_generic) ((generics.Bar2_interface__int_generic<java.lang.Object>) generics.Bar2.<java.lang.Integer, java.lang.Object>factory$newBar(dart2java$localTypeEnv.extend(generics.Bar2.factory$newBar$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0), dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Object)}), 0, 0))));
      nestedGeneric12.writeVariable(((generics.Bar2_interface__int_generic) ((generics.Bar2_interface__int_int) generics.Bar2.<java.lang.Integer, java.lang.Integer>factory$newBar(dart2java$localTypeEnv.extend(generics.Bar2.factory$newBar$typeInfo.typeVariables, new dart._runtime.types.simple.Type[] {dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0), dart2java$localTypeEnv.evaluate(dart2java$typeExpr_int$0)}), 50, 51))));
      dart.core.__TopLevel.print(nestedGeneric12.foo(((generics.Bar2_interface__int_generic) nestedGeneric12.getVariable())).getVarA__int_generic());
      dart.core.__TopLevel.print(nestedGeneric12.getVariable().getVarB__int_generic());
    }
}
