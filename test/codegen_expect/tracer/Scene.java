...
public class Scene extends dart._runtime.base.DartObject implements tracer.Scene_interface
{
    ...
    public void _constructor()
    {
      ...
      super._constructor();
      this.setCamera(tracer.Camera._new_Camera$(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Camera), tracer.Vector._new_Vector$(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Vector), 0.0, 0.0, (-0.5)), tracer.Vector._new_Vector$(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Vector), 0.0, 0.0, 1.0), tracer.Vector._new_Vector$(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Vector), 0.0, 1.0, 0.0)));
      ...
      this.setBackground(tracer.Background._new_Background$(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Background), tracer.Color._new_Color$(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Color), 0.0, 0.0, 0.5), 0.2));
    }
    ...
    public static tracer.Scene_interface _new_Scene$(dart._runtime.types.simple.Type type)
    {
      tracer.Scene result;
