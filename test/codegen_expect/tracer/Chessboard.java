...
{
    public static dart._runtime.types.simple.InterfaceTypeInfo dart2java$typeInfo = new dart._runtime.types.simple.InterfaceTypeInfo("file:///usr/local/google/home/springerm/ddc-java/gen/codegen_tests/tracer.dart", "Chessboard");
    static {
    ...
    public Chessboard(tracer.Color colorEven, tracer.Color colorOdd, java.lang.Object reflection, java.lang.Object transparency, java.lang.Object gloss, java.lang.Double density)
    {
      super((dart._runtime.helpers.ConstructorHelper.EmptyConstructorMarker) null);
      this._constructor(colorEven, colorOdd, reflection, transparency, gloss, density);
    }
    public Chessboard(dart._runtime.helpers.ConstructorHelper.EmptyConstructorMarker arg)
    {
      super(arg);
    }
