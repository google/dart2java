...
public class __TopLevel
{
    ...
    {
      final dart._runtime.types.simple.TypeEnvironment dart2java$localTypeEnv = dart._runtime.types.simple.TypeEnvironment.ROOT;
      tracer.Scene scene = new tracer.Scene(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Scene.dart2java$typeInfo)));
      ...
      tracer.Light light = new tracer.Light(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Light.dart2java$typeInfo)), new tracer.Vector(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Vector.dart2java$typeInfo)), 5.0, 10.0, dart._runtime.helpers.DoubleHelper.operatorUnaryMinus(1.0)), new tracer.Color(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Color.dart2java$typeInfo)), 0.8, 0.8, 0.8), 10.0);
      tracer.Light light1 = new tracer.Light(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Light.dart2java$typeInfo)), new tracer.Vector(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Vector.dart2java$typeInfo)), dart._runtime.helpers.DoubleHelper.operatorUnaryMinus(3.0), 5.0, dart._runtime.helpers.DoubleHelper.operatorUnaryMinus(15.0)), new tracer.Color(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Color.dart2java$typeInfo)), 0.8, 0.8, 0.8), 100.0);
      ...
      int rayDepth = 2;
      tracer.Engine raytracer = new tracer.Engine(dart2java$localTypeEnv.evaluate(new dart._runtime.types.simple.InterfaceTypeExpr(tracer.Engine.dart2java$typeInfo)), imageWidth, imageHeight, pixelSize, pixelSize, renderDiffuse, renderShadows, renderHighlights, renderReflections, rayDepth);
