...
public class B14 extends dart._runtime.base.DartObject implements interface_type_profile.B14_interface, interface_type_profile.A3_interface, interface_type_profile.A2_interface, interface_type_profile.A1_interface
{
    public static dart._runtime.types.simple.InterfaceTypeInfo dart2java$typeInfo = new dart._runtime.types.simple.InterfaceTypeInfo(interface_type_profile.B14.class, interface_type_profile.B14_interface.class);
    ...
    static {
      interface_type_profile.B14.dart2java$typeInfo.superclass = dart2java$typeExpr_Object;
    ...
    public static interface_type_profile.B14_interface _new_B14$(dart._runtime.types.simple.Type type)
    {
      interface_type_profile.B14 result;
