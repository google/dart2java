...
public class C4 extends dart._runtime.base.DartObject implements interface_type_profile.C4_interface, interface_type_profile.B4_interface, interface_type_profile.B5_interface
{
    ...
    static {
      interface_type_profile.C4.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
      interface_type_profile.C4.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B4.dart2java$typeInfo), new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B5.dart2java$typeInfo)};
    }
  
    public C4(dart._runtime.types.simple.Type type)
    {
