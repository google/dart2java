...
public class C11 extends dart._runtime.base.DartObject implements interface_type_profile.C11_interface, interface_type_profile.B11_interface, interface_type_profile.B12_interface
{
    ...
    static {
      interface_type_profile.C11.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
      interface_type_profile.C11.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B11.dart2java$typeInfo), new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B12.dart2java$typeInfo)};
    }
  
    public C11(dart._runtime.types.simple.Type type)
    {
