...
public class __TopLevel
{
    ...
    static {
      ...
      interface_type_profile.__TopLevel.level0 = ((dart.core.List_interface) dart._runtime.base.DartList.Generic._fromArguments(java.lang.Object.class, ((interface_type_profile.A0_interface) interface_type_profile.A0._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_A0))), ((interface_type_profile.A1_interface) interface_type_profile.A1._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_A1))), ((interface_type_profile.A2_interface) interface_type_profile.A2._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_A2))), ((interface_type_profile.A3_interface) interface_type_profile.A3._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_A3)))));
      interface_type_profile.__TopLevel.level1 = ((dart.core.List_interface) dart._runtime.base.DartList.Generic._fromArguments(java.lang.Object.class, ((interface_type_profile.B0_interface) interface_type_profile.B0._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B0))), ((interface_type_profile.B1_interface) interface_type_profile.B1._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B1))), ((interface_type_profile.B2_interface) interface_type_profile.B2._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B2))), ((interface_type_profile.B3_interface) interface_type_profile.B3._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B3))), ((interface_type_profile.B4_interface) interface_type_profile.B4._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B4))), ((interface_type_profile.B5_interface) interface_type_profile.B5._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B5))), ((interface_type_profile.B6_interface) interface_type_profile.B6._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B6))), ((interface_type_profile.B7_interface) interface_type_profile.B7._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B7))), ((interface_type_profile.B8_interface) interface_type_profile.B8._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B8))), ((interface_type_profile.B9_interface) interface_type_profile.B9._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B9))), ((interface_type_profile.B10_interface) interface_type_profile.B10._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B10))), ((interface_type_profile.B11_interface) interface_type_profile.B11._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B11))), ((interface_type_profile.B12_interface) interface_type_profile.B12._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B12))), ((interface_type_profile.B13_interface) interface_type_profile.B13._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B13))), ((interface_type_profile.B14_interface) interface_type_profile.B14._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B14))), ((interface_type_profile.B15_interface) interface_type_profile.B15._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_B15)))));
      interface_type_profile.__TopLevel.level2 = ((dart.core.List_interface) dart._runtime.base.DartList.Generic._fromArguments(java.lang.Object.class, ((interface_type_profile.C0_interface) interface_type_profile.C0._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C0))), ((interface_type_profile.C1_interface) interface_type_profile.C1._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C1))), ((interface_type_profile.C2_interface) interface_type_profile.C2._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C2))), ((interface_type_profile.C3_interface) interface_type_profile.C3._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C3))), ((interface_type_profile.C4_interface) interface_type_profile.C4._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C4))), ((interface_type_profile.C5_interface) interface_type_profile.C5._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C5))), ((interface_type_profile.C6_interface) interface_type_profile.C6._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C6))), ((interface_type_profile.C7_interface) interface_type_profile.C7._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C7))), ((interface_type_profile.C8_interface) interface_type_profile.C8._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C8))), ((interface_type_profile.C9_interface) interface_type_profile.C9._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C9))), ((interface_type_profile.C10_interface) interface_type_profile.C10._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C10))), ((interface_type_profile.C11_interface) interface_type_profile.C11._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C11))), ((interface_type_profile.C12_interface) interface_type_profile.C12._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C12))), ((interface_type_profile.C13_interface) interface_type_profile.C13._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C13))), ((interface_type_profile.C14_interface) interface_type_profile.C14._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C14))), ((interface_type_profile.C15_interface) interface_type_profile.C15._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_C15)))));
      interface_type_profile.__TopLevel.others = ((dart.core.List_interface) dart._runtime.base.DartList.Generic._fromArguments(java.lang.Object.class, null, 3, 4.5, true, "string", ((java.lang.Object) dart._runtime.base.DartObject._new(dart2java$localTypeEnv.evaluate(dart2java$typeExpr_Object))), ((java.lang.Object) interface_type_profile.__TopLevel.level0)));
    }
    ...
    {
      final dart._runtime.types.simple.TypeEnvironment dart2java$localTypeEnv = dart._runtime.types.simple.TypeEnvironment.ROOT;
      return l.operatorAt(interface_type_profile.__TopLevel._rnd.nextInt(l.getLength()));
    }
