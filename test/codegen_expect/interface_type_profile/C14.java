...
public class C14 extends dart._runtime.base.DartObject implements interface_type_profile.C14_interface, interface_type_profile.B14_interface, interface_type_profile.B15_interface
{
    ...
    static {
      interface_type_profile.C14.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
      interface_type_profile.C14.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B14.dart2java$typeInfo), new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B15.dart2java$typeInfo)};
    }
  
    public C14(dart._runtime.types.simple.Type type)
    {
