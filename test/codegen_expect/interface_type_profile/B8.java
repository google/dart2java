...
public class B8 extends dart._runtime.base.DartObject implements interface_type_profile.B8_interface, interface_type_profile.A3_interface
{
    public static dart._runtime.types.simple.InterfaceTypeInfo dart2java$typeInfo = new dart._runtime.types.simple.InterfaceTypeInfo(interface_type_profile.B8.class, interface_type_profile.B8_interface.class);
    ...
    static {
      interface_type_profile.B8.dart2java$typeInfo.superclass = dart2java$typeExpr_Object;
    ...
    public static interface_type_profile.B8_interface _new_B8$(dart._runtime.types.simple.Type type)
    {
      interface_type_profile.B8 result;
