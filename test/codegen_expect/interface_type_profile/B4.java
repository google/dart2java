...
public class B4 extends dart._runtime.base.DartObject implements interface_type_profile.B4_interface, interface_type_profile.A2_interface
{
    ...
    static {
      interface_type_profile.B4.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
      interface_type_profile.B4.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.A2.dart2java$typeInfo)};
    }
  
    public B4(dart._runtime.types.simple.Type type)
    {
