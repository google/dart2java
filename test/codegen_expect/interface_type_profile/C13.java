...
public class C13 extends dart._runtime.base.DartObject implements interface_type_profile.C13_interface, interface_type_profile.B13_interface, interface_type_profile.B14_interface
{
    ...
    static {
      interface_type_profile.C13.dart2java$typeInfo.superclass = new dart._runtime.types.simple.InterfaceTypeExpr(dart._runtime.helpers.ObjectHelper.dart2java$typeInfo);
      interface_type_profile.C13.dart2java$typeInfo.interfaces = new dart._runtime.types.simple.InterfaceTypeExpr[] {new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B13.dart2java$typeInfo), new dart._runtime.types.simple.InterfaceTypeExpr(interface_type_profile.B14.dart2java$typeInfo)};
    }
  
    public C13(dart._runtime.types.simple.Type type)
    {
